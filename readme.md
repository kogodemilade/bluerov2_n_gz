...
This is due to the fact that it needs to be sufficiently close to the floor, which will be changed in future commits. The pointcloud topic should also be changed to /robot_0/... (the default topic is wrong and will be changed).
